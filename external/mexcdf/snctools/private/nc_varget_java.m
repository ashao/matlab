...
snc_validate_idx(start,count,stride,num_var_dims);
...
[read_method,start,count] = determine_read_method(start,count,stride,varinfo);
...
%--------------------------------------------------------------------------
function [read_method,start,count] = determine_read_method(start,count,stride,varinfo)
...
%--------------------------------------------------------------------------
function values = post_process_strings(jvarid,jdata)
